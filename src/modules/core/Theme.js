...
let theme1 = {	bkgColor: 			'#605555',
				...
				posFont:			{ fill: 'black', size:  9, family: 'Arial, Helvetica, sans-serif' },
				coordinateFont:		{ fill: 'black', size: 11, family: 'Arial, Helvetica, sans-serif', weight: 'bold' },
				titleFontNameLarge:	{ fill: 'black', size: 12, family: 'Arial, Helvetica, sans-serif', weight: 'bold' },
				titleFontValueLarge:{ fill: 'blue', size: 12, family: 'Arial, Helvetica, sans-serif', weight: 'bold' },
				titleFontName:		{ fill: 'black', size: 10, family: 'Arial, Helvetica, sans-serif' },
				titleFontValue:		{ fill: 'blue', size: 10, family: 'Arial, Helvetica, sans-serif' },
				landmarkFont:		{ fill: '#33e', size: 9.5, family: 'Arial, Helvetica, sans-serif' },
				landmarkFontBold:	{ fill: '#00e', size: 10, family: 'Arial, Helvetica, sans-serif', weight: 'bold' },
				regionFont:			{ fill: 'black', size:  9 },
				regionFontZoom:		{ fill: 'black', size: 11, family: 'Arial, Helvetica, sans-serif' },

				annotationFont:		{ fill: 'black', size: 10, family: 'Arial, Helvetica, sans-serif' , anchor: 'start', weight: 'bold' },
				annotationDescFont:	{ fill: '#555', size: 10, family: 'Arial, Helvetica, sans-serif' , anchor: 'start', weight: 'bold' },
				annotationPosFont:	{ fill: '#55f', size: 10, family: 'Arial, Helvetica, sans-serif', anchor: 'end', weight: 'bold' },
				annotationFontBlur:	{ fill: '#333', size: 10, family: 'Arial, Helvetica, sans-serif' , anchor: 'start' },
				annotationDescFontBlur:{fill: '#777', size: 10, family: 'Arial, Helvetica, sans-serif' , anchor: 'start' },
				annotationPosFontBlur:{ fill: '#77F', size: 10, family: 'Arial, Helvetica, sans-serif', anchor: 'end' },
				...
				tabFont:			{ fill: 'black', size: 10, family: 'Arial, Helvetica, sans-serif' , weight: 'bold' },
				tabColor: 			'#aca8bb',
...
let theme2 = {	bkgColor: 			'#646890',//'#626492',
				...
				titleFontName:		{ fill: 'black', size: 10, family: 'Arial, Helvetica, sans-serif' },
				titleFontValue:		{ fill: 'blue', size: 10, family: 'Arial, Helvetica, sans-serif' },
				landmarkFont:		{ fill: '#77f', size: 9.5, family: 'Arial, Helvetica, sans-serif' },
				landmarkFontBold:	{ fill: '#00e', size: 10, family: 'Arial, Helvetica, sans-serif', weight: 'bold' },
				regionFont:			{ fill: 'black', size:  9 },
				regionFontZoom:		{ fill: 'black', size: 11, family: 'Arial, Helvetica, sans-serif' },
				annotationFont:		{ fill: 'black', size: 10, family: 'Arial, Helvetica, sans-serif' , anchor: 'start', weight: 'bold' },
				annotationDescFont:	{ fill: '#555', size: 10, family: 'Arial, Helvetica, sans-serif' , anchor: 'start', weight: 'bold' },
				annotationPosFont:	{ fill: '#fff', size: 10, family: 'Arial, Helvetica, sans-serif', anchor: 'end', weight: 'bold' },
				annotationFontBlur:	{ fill: '#333', size: 10, family: 'Arial, Helvetica, sans-serif' , anchor: 'start' },
				annotationDescFontBlur:{fill: '#777', size: 10, family: 'Arial, Helvetica, sans-serif' , anchor: 'start' },
				annotationPosFontBlur:{ fill: '#77F', size: 10, family: 'Arial, Helvetica, sans-serif', anchor: 'end' },
