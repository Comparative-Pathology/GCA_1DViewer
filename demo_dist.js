...
* Corresponding HTML file: demo.html
* Dependancies: GCA_Viewer1D  
* This demo is based on the webpack library version of the GCA_Viewer1D. It does not require GCA_Viewer1D source 
*/
 
export { DemoViewer} 

let Viewer1D = GCA_Viewer1D.Viewer1D;   // use the distribution library instead of the source code
...
class DemoViewer extends EventTarget {
	constructor (container) {
		...
		this.viewer1D.loadModel('models/EdinGCA_1D_00010_1_18.json', this.handleModelReady.bind(this))  // Load and display a 1D model and set a callback for any required post load processing  
	}
